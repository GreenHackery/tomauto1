...
def generate_launch_description():
    ...
    nav2_params_path = os.path.join(get_package_share_directory('tomauto1_bringup'), 'config', 'nav2_params.grow_tent.yaml')
    map_path = '/home/daniel/projects/foodlikeair/tomauto1/src/tomauto1_bringup/maps/grow_tent_mock/map.yaml'
    world_path = os.path.join(get_package_share_directory('tomauto1_bringup'), 'worlds', 'grow_tent_mock.sdf')
    ...
    gui_config_path = os.path.join(
        get_package_share_directory('tomauto1_bringup'),
        'config',
        'gazebo_gui.config'
    )
